...
export const policiesAPI = {
  ...
  downloadDoc: (id, type = "docx") =>
    api.get(`/policies/${id}/download-document`, {
      params: { file_type: type },
      responseType: "blob",
    }),
  triggerEmail: (id, triggerType) =>
    api.post(`/policies/${id}/trigger-email`, null, {
      params: { trigger_type: triggerType },
    }),
  exportCsv: (params) =>
    api.get("/policies/export/csv", { params, responseType: "blob" }),
};
...
export const approvalsAPI = {
  ...
  pendingAtRisk: (days) =>
    api.get("/approvals/pending-near-expiry", { params: { days } }),
};
